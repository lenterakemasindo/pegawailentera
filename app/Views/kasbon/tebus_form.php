  ...
  foreach ($json->data as $data) : ?>
    ...
    <div class="card collapsed-card card-info">
      <div class="card-header">
        <h3 class="card-title">Pengajuan Tanggal <?= formatDate($data->tgl); ?></h3>
        ...
        <div class="row">
          <div class="col">
            <div class="form-group">
              ...
              <input type="date" class="form-control form-control-border" name="tgl" value="<?= $data->tgl; ?>">
            </div>
          </div>
          <div class="col">
            <div class="form-group">
              <label class="form-label">Jumlah</label>
              <input type="number" class="form-control form-control-border" placeholder="Masukan Data ..." autocomplete="off" name="jumlah" value="<?= $data->jumlah; ?>">
            </div>
          </div>
        </div>
        <div class="form-group">
